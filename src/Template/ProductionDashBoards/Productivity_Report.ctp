...
?>
<div class="panel-group" id="accordion-db2" role="tablist" aria-multiselectable="true" style="margin-top:10px;">
    <div class="container-fluid">

        <div class="panel panel-default formcontent">
            <div class="panel-heading" role="tab" id="headingTwo">
                <h3 class="panel-title">
                    <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion-db2" href="#collapsedb2" aria-expanded="false" aria-controls="collapseTwo" style="text-decoration:none;">
                        <i class="more-less glyphicon glyphicon-plus"></i>
                        Production DashBoard Productivity Report
                    </a> 
                </h3>
            </div>
            <div id="collapsedb2" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingTwo">
                ...
                <div class="col-md-4">
                    ...
                    if ($RegionId == '') {
                        ...
                        echo $this->Form->input('', array('options' => $Region, 'id' => 'RegionId','style' => 'width:220px', 'name' => 'RegionId', 'class' => 'form-control', 'value' => $RegionId, 'onchange' => 'getusergroupdetails(this.value)'));
                    } else {
                        echo $RegionId;
                    }
                    ?>
        ...
        //echo $this->Form->input('', array('options' => $Status, 'default' => '0', 'class' => 'form-control', 'selected' => $poststatus, 'value' => $poststatus, 'id' => 'status', 'name' => 'status', 'style' => 'height:100px', 'multiple' => true));
            ...
            echo $this->Form->submit('Export Productivity Report Results', array('id' => 'productivityReport_downloadFile', 'name' => 'productivityReport_downloadFile', 'value' => 'productivityReport_downloadFile', 'style' => 'margin-left:35px;float:left;display:inline;padding-bottom:6px;', 'class' => 'btn btn-primary btn-sm', 'onclick' => 'return Mandatory()', 'type' => 'submit'));
              ?>
                        <span id='xlscnt' style="float:right; margin-right:20px; margin-top:27px;display:none;">
                            <button type='submit' name='productivityReport_downloadFile' id='productivityReport_downloadFile' value='productivityReport_downloadFile'><img width="20" height="20" src="img/file-xls.jpg"><img width="12" height="12" src="img/down_arrow.gif"></button>
                        </span>
                            ...
                            <table style='width:100%;' class="table table-striped table-center" id='example'>
                                ...
                                <thead>
                                    <tr class="Heading">
                                        ...
                                        <th class="Cell" width="20%">User Group</th> 
                                            <?php
											foreach ($moduleDetails as $key => $val){
                                            ?>
                                        <th class="Cell" width="20%"><?php echo $module[$val]; ?></th>
                                            <?php
											}
                                            ?>
                                    </tr>
                                ...
                                <tbody><?php
                                        ...
                                        foreach ($Production_dashboard as $inputVal => $input):
                                            ?>
                                    <tr>
                                        <td><?php echo $input['UserId']; ?></td>
                                        <td><?php echo $input['UserGroupId']; ?></td>
                                                <?php
												foreach ($moduleDetails as $key=>$val){
													?>
                                        <td><?php echo $input[$val]; ?></td>	
													<?php
												}
												?>
                                    </tr>
...
<?php
if (isset($this->request->data['productivityReport_submit']) || isset($this->request->data['productivityReport_downloadFile'])) {
    ?>
<script>
