    ...
    <div class=" jumbotron formcontent">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <?php
                    echo $this->Form->input('', array('options' => $Projects, 'id' => 'ProjectId', 'name' => 'ProjectId', 'class' => 'form-control prodash-txt', 'value' => $ProjectId, 'onchange' => 'getRegion(this.value);getModule(this.value);'));
                    ?>
                </div>
            </div>
        </div>
...
//                exit;
                    foreach ($Production_dashboard as $inputVal => $input):
                        ...
                        if ($Resource != '') {
                            ...
                            //$EdiT = $this->Html->link('Click to View', ['controller' => 'ProductionView', 'action' => 'view', $url]);
                            //  $EdiT = $this->Html->link('Click to View', ['controller' => 'ProductionView', 'onclick' => 'viewjob('.$ModuleId.');']);
                            //}
                            //if (($SId == '12') || ($SId == '9')) {
                            ...
                            //}
                            ?>
                <form target="_blank" method="post" action="ProductionView" name="ProductionView_<?php echo $i; ?>">
