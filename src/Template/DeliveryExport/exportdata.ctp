...
<!--        <div class="col-md-4">
        ...
        <div class="form-group but_align" style="text-align:center;">
            ...
            echo $this->Form->Submit('View', array( 'id' => 'check_view', 'name' => 'check_view', 'value' => 'View','style'=>'','class'=>'btn btn-primary btn-sm clea_buttun','onclick'=>'return Mandatory()'));
                ...
                <?php echo $this->Html->tableHeaders(array('Date','Status','Action'),array('class' => 'Heading'),array('class' => 'Cell'));
                    ...
                    foreach ($files as $data):
                        ...
                        echo $this->Html->tableCells(array(
                            array(
                                ...
                                array('Completed',array('class' => 'Cell')),
                                array($this->Html->link('Export',$file_path.$data),array('class' => 'Cell')),
                                )
                    ...
                    endforeach;
                      ...
                      echo $this->Html->tableCells(array(
                            array(
                                array(date('d-M-Y', strtotime($from_date)) ,array('class' => 'Cell')),
                                array('No Files Found',array('class' => 'Cell')),
...
<script type="text/javascript">
    ...
    function asynch(projectid,regionid,inpdate){
        alert(inpdate);
        $.ajax({
