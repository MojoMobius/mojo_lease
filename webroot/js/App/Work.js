          ...
          $(this).selective({
            ...
            tpl: {
              ...
              triggerButton: function triggerButton() {
                return '<div class="' + this.namespace + '-trigger-button"><span style="color:#000;"><i class="fa fa-plus fa-1"></i></span></div>';
              },
              ...
              itemRemove: function itemRemove() {
                return '<span class="' + this.namespace + '-remove"><i class="fa fa-minus-circle fa-1"></i></span>';
              },
